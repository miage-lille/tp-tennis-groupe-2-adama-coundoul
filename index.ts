...
import { Advantage,advantage, deuce, fifteen, forty, FortyData, game, love, Point, points, PointsData, Score, thirty } from './types/score';
...
throw new Error('Game already won, no more transitions');};
